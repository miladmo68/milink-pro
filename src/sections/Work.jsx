...
/* ===========================
   Work Section (fixed initial alignment)
=========================== */
export default function Work() {
  const [open, setOpen] = useState(false);
  const [item, setItem] = useState(null);
          ...
          >
            {work.map((w) => (
              ...
              >
                ...
                {/* Title: ثابت در کف چپ (بدون تغییر bottom در hover) */}
                <h3
                  className="
                ...
                {/* Live link icon: ثابت در کف راست (کاملاً مستقل از تیتر) */}
                {w.liveUrl && (
                  <a
                    href={w.liveUrl}
                    target="_blank"
