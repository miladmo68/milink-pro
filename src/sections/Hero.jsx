...
export default function Hero({ onOpenLightbox }) {
  ...
  return (
    <section
      id="home"
      // موبایل: همون قبلی (بدون تغییر)
      // md و بالاتر: همیشه قدِ صفحه، بدون بریدن محتوا
      className="relative bg-transparent md:min-h-[100dvh] lg:min-h-[100dvh]"
    >
      {/* ===== BACKGROUND STACK ===== */}
      ...
      {/* ===== FOREGROUND CONTENT ===== */}
      {/* روی md+ چون min-h فول‌اسکرین داریم، h-full می‌زنیم تا عمودی سنتر بماند */}
