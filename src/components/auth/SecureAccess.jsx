...
export default function SecureAccess({ area = "client", initialNotice = "" }) {
  ...
  // Supabase validates redirect URLs literally. Keep this callback URL query-free
  // so both local and production match the entries in Supabase URL Configuration.
  const portalVerificationRedirect = () => `${getBaseUrl()}/auth/callback`;
