...
//     "radial-gradient(120% 160% at 90% 20%, rgba(0,115,255,0.08) 0%, rgba(0,115,255,0) 60%), linear-gradient(180deg, rgba(22,27,38,0.92), rgba(14,18,28,0.90))";
...
//       >
//         {/* ========== Desktop (بدون تغییر) ========== */}
//         <div className="container navbar py-4 hidden md:flex items-center gap-6">
//           <div className="flex items-center gap-1">
//             <div
//               className="hidden md:block shrink-0 overflow-hidden m-0 p-0 leading-none"
//               style={{ width: LOGO_BOX_WIDTH, transform: "translateY(1px)" }}
...
//               border: "1px solid rgba(255,255,255,0.10)",
//               boxShadow:
//                 "0 18px 48px rgba(0,0,0,0.40), 0 0 40px rgba(0,96,255,0.10)",
