...
export default function Navbar() {
  ...
  // ✅ detect theme from data-theme (DaisyUI)
  ...
  useEffect(() => {
    ...
    const compute = () => {
      ...
      // اگر تم‌های سفارشی داری که لایت حساب میشن، اینجا add کن
  ...
  // ✅ Desktop link styles: Light readable, Dark same vibe
  ...
  // ✅ Mobile TOP pill: Dark = your old one, Light = bright version
  ...
  // ✅ Drawer BG: Dark = your old one, Light = bright version
